...
local trueData = "201382107572424398d1762a5393fd66"
local falseData = "4fb1a81861c24231949e713f654db0fd"

KeyGuardLibrary.Set({
	publicToken = "cdd83a752c3f416bbda9477f70c1be31",
	privateToken = "24f0dabb9a4142e2aee71b6add45a828",
	trueData = trueData,
	falseData = falseData,
})
...
Window:SelectTab(1)local exploit = getexecutorname or identifyexecutor
local support = {
    ["Fluxus"] = true,
    ["Trigon"] = false,
    ["Codex"] = true,
                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script LH hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
setclipboard("LH hub Is The Best")
...
Fluent:Notify({
    Title = "LH hub",
    Content = "Thanks For Using LH hub",
    Duration = 8
})
